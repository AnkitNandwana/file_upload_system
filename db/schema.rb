...
ActiveRecord::Schema[8.0].define(version: 2025_08_15_073416) do
  ...
  create_table "shared_links", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["file_record_id"], name: "index_shared_links_on_file_record_id"
  end
  ...
  add_foreign_key "shared_links", "file_records"
end
